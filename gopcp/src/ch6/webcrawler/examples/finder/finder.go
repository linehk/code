...
import (
	...
	lib "ch6/webcrawler/examples/finder/internal"
	"ch6/webcrawler/examples/finder/monitor"
...
func main() {
	...
	// 开始监控。
	checkCountChan := monitor.Monitor(scheduler, checkInterval,
		summarizeInterval, maxIdleCount, true, lib.Record)
