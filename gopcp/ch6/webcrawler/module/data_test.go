...
func TestRequest(t *testing.T) {
	...
	if req.HTTPReq() != expectedHTTPReq {
		t.Fatalf("Inconsistent HTTP request for request: expected: %#v, "+
			"actual: %#v", expectedHTTPReq, req.HTTPReq())
	}
...
func TestResponse(t *testing.T) {
	...
	if resp.HTTPResp() != expectedHTTPResp {
		t.Fatalf("Inconsistent HTTP response for response: expected: %#v, "+
			"actual: %#v", expectedHTTPResp, resp.HTTPResp())
	}
