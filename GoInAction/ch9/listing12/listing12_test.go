...
// Differs slightly from the back to show more.
package listing12
...
func TestDownload(t *testing.T) {
	...
	t.Log("Given the need to test downloading content.")
	{
			...
			server.URL, statusCode)
		{
			...
			t.Logf("\t\tShould reveive a \"%d\" status. %v",
...
// Document defines the fields associated with the busy RSS document.
